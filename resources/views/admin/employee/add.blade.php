      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            ...
            {{ Form::open(['route'=>['admin.saveEmployee'],'files'=>true])}}
              <div class="row">

                <div class="col-md-4">
                 <div class="form-group" id="stateDiv">
                    {{ Form::label('role','Role') }}
                    {!!Form::select('role', $roles, '', ['placeholder' => 'Select role','class'=>'form-control custom-select select2','id'=>'role'])!!}
                ...
                <div class="col-md-4">
                 <div class="form-group" id="stateDiv">
                    ...
                    {!!Form::select('assign_process[]', $AssignProcess, '', ['class'=>'form-control custom-select select2','id'=>'assign_process','multiple'=>true,'required'=>true])!!}
                 ...
                 <div class="col-md-4">
                   <div class="form-group">
                      ...
                      {{ Form::text('employee_code','',['class'=>'form-control','placeholder'=>'Employee code']) }}
                ...
                <div class="col-md-4">
                 <div class="form-group">
                    ...
                    {{ Form::text('tag','',['class'=>'form-control','placeholder'=>'Tag (Employee / Contingent)']) }}
              ...
              {{--  <div class="col-md-4">
                ...
                <div class="col-md-4">
                 <div class="form-group">
                    ...
                    {!!Form::select('approver_manager', $managers, '', ['placeholder' => 'Approver manager','class'=>'form-control custom-select select2','id'=>'approver_manager'])!!}
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    {{ Form::text('location','',['class'=>'form-control','placeholder'=>'Address 2']) }}
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                    <div class="icheck-primary d-inline">
                      {{ Form::checkbox('medical_welfare','Yes','',['class'=>'form-control','placeholder'=>'Medical Welfare category access','id'=>'medical_welfare']) }}
                      {{ Form::label('medical_welfare','Medical Welfare category access') }}
                    </div>
                  </div>
