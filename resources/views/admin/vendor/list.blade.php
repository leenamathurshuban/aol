              ...
              <div class="card-header">
                <div class="row">
                  <div class="col-sm-12 col-md-1">
                    {{ link_to_route('admin.addVendor','Add',[],['class'=>'btn btn-outline-primary','title'=>'Add New']) }}
                  </div>
        					<div class="col-sm-12 col-md-11">
                    {!! Form::open(['method'=>'GET','files'=>true])!!}
                       <div class="row yemm_serachbox">
                        <div class="col-sm-12 col-md-10">
                          {{ Form::text('name',$name,['class'=>'form-control','placeholder'=>'Search by name']) }}
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <button class="btn btn-app btn-view" title="View" onclick="getVendorDetail('{{ $result->id }}')"><i class="fas fa-eye"></i>View</button>
                    	...
                    	{!! Html::decode(link_to_route('admin.editVendor','<i class="fas fa-edit"></i>Edit',[$result->id,$currentPage],['class'=>'btn btn-app btn-edit','title'=>'Edit'])) !!}

                    	{!! Html::decode(link_to_route('admin.removeVendor','<i class="fas fa-trash"></i>Delete',[$result->id],['class'=>'btn btn-app btn-delete','title'=>'Remove','onclick'=>'return removeData()'])) !!}
                    </td>
                  </tr>
                 @empty
                 <tr>
