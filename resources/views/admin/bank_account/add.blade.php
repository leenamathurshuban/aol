      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            ...
            {{ Form::open(['route'=>['admin.saveBankAccount'],'files'=>true])}}
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    {{ Form::text('bank_account_number','',['class'=>'form-control','placeholder'=>'Bank Account Number']) }}
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    {{ Form::text('branch_address','',['class'=>'form-control','placeholder'=>'Branch Address']) }}
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    {{ Form::text('branch_code','',['class'=>'form-control','placeholder'=>'Branch Code']) }}
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    {{ Form::text('bank_account_holder','',['class'=>'form-control','placeholder'=>'Account Holder Name']) }}
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    {{ Form::text('ifsc','',['class'=>'form-control','placeholder'=>'Bank IFSC']) }}
