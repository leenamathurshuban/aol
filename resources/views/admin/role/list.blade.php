              ...
              <div class="card-header">
                <div class="row">
        					<div class="col-sm-12 col-md-2">
        						{{ link_to_route('admin.addRole','Add New',[],['class'=>'btn btn-outline-primary','title'=>'Add New']) }}
        					</div>
                  <div class="col-sm-12 col-md-2">
                    ...
                    {!! Form::open(['method'=>'GET','files'=>true])!!}
                       <div class="row yemm_serachbox">
                        <div class="col-sm-12 col-md-12 main_serach">
                            <div class="form-group">
                                 {{ Form::text('name',$name,['class'=>'form-control','placeholder'=>'Search by role']) }}
              ...
              <div class="card-body">
                ...
                @forelse($data as $result)
                  <tr>
                    ...
                    <td>
                    	{!! Html::decode(link_to_route('admin.editRole','<i class="fas fa-edit"></i>Edit',[$result->slug],['class'=>'btn btn-app btn-edit','title'=>'Edit'])) !!}
                      ...
                      {!! Html::decode(link_to_route('admin.removeTrashedRole','<i class="fas fa-trash"></i>Delete',[$result->slug],['class'=>'btn btn-app btn-delete','title'=>'Remove','onclick'=>'return removeData()'])) !!}--}}
