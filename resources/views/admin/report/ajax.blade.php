            ...
            @forelse($data as $itemKey => $itemVal)
              <tr class="poAppInvTR">
                ...
                <td>
                  ...
                  <p><strong>TDS Month: </strong>{{ ($itemVal->tds_month) }}</p>
...
@elseif($type=='InvoiceDetail')
  <div class="col-md-12 vander_dataview">
    ...
    <ul>
      ...
      <li>
        <strong>Unique Id:</strong><p>{{ $data->order_id }}</p>
      </li>
      <li>
      ...
      <li>
        <strong>Taxable Amount:</strong><p>{{ env('CURRENCY_SYMBOL').''. $data->invoice_amount }}</p>
      </li>
      <li>
        <strong>TDS:</strong><p>{{ $data->tds }}%</p>
      </li>
      <li>
        <strong>TDS Month:</strong><p>{{ $data->tds_month ?? '' }}</p>
      </li>
      <li>
        <strong>TDS Amount:</strong><p>{{ env('CURRENCY_SYMBOL').''. $data->tds_amount }}</p>
      </li>
      <li>
        <strong>Total:</strong><p>{{ env('CURRENCY_SYMBOL').''. $data->tds_payable }}</p>
      </li>
      <li>
    ...
    @if($data->form_by_account)
      ...
      <table class="table">
        ...
        <tr>
          ...
          <th><strong>Transaction Date</strong><p>{{$data->transaction_date ?? ''}}</p></th>
          <th></th>
        </tr>
      </table>
      <table class="table">
