        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Employee Paid Report</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
               <div class="card-header">
                  ...
                  {!! Form::open(['route'=>['admin.AdminSingleRequestExport','empPaidRep'],'method'=>'','files'=>true])!!}
                  <div class="row">
                    <div class="col-md-3">
                  ...
                  <div class="col-md-3">
                    {{ Form::label('Pay Bank Account','Payment Bank Account')}}
                    {{ Form::select('acc_no',\App\BankAccount::bnkHeadOfcPluck(),[],['class'=>'form-control custom-select select2','placeholder'=>'All']) }}
            ...
            {!! Form::open(['method'=>'GET','files'=>true])!!}
              <div class="card-header">
                <div class="row">
                  ...
                  <div class="col-md-3">
                    {{ Form::label('Pay Bank Account','Payment Bank Account')}}
                    {{ Form::select('pay_for',\App\BankAccount::bnkHeadOfcPluck(),$pay_for,['class'=>'form-control custom-select select2','placeholder'=>'All']) }}
                  </div>
                ...
                <div class="wrapper2">
                    <div class="div2">
                        ...
                        @forelse($data as $result)
                          ...
                          @php
                            $bnkAccNumber='';
                            $item=json_decode($result->form_by_account);
                            if($result->form_by_account && $item){
