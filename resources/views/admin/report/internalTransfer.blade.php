        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Inter Bank Transfer</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                  ...
                  {!! Form::open(['route'=>['admin.AdminSingleRequestExport','bnkRtrn'],'method'=>'','files'=>true])!!}
                  <div class="row">
                    <div class="col-md-3">
            ...
            {!! Form::open(['method'=>'GET','files'=>true])!!}
              <div class="card-header">
                ...
                {{--	<div class="col-md-2">
                	...
                	<div class="col-md-3">
                		{{ Form::label('From','Transaction Date From')}}
                      ...
                      @forelse($data as $result)
                        ...
                        <tr>
                         ...
                         <td>
                          ...
                          <td>{{ json_decode($result->transfer_from_ary)->bank_account_number ?? '' }}</td>
                          <td>{{ json_decode($result->transfer_from_ary)->ifsc ?? '' }}</td>
                          <td>{{ json_decode($result->transfer_to_ary)->bank_account_number ?? '' }}</td>
                          <td>{{ json_decode($result->transfer_to_ary)->ifsc ?? '' }}</td>
                          <td>
