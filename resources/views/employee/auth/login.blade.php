...
<body class="hold-transition login-page">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form method="POST" action="{{ route('employeeCheckLogin') }}">
                        @csrf
                        <?php 
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Terms of usage are governed by the terms of employment. All information recorded or displayed on this system is confidential and cannot be shared, copied, recorded or transferred.</p>
        </div>
