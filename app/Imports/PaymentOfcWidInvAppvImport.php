...
class PaymentOfcWidInvAppvImport implements ToModel, WithStartRow,WithHeadingRow,WithValidation,SkipsOnFailure
{
    ...
    */
    ...
    {
    	$data=WithoutPoInvoice::where(['invoice_status'=>5,'order_id'=>$row['generated_id']])->first();
    	if ($data) {
    ...
    public function rules(): array
    {
        $valid='';
        return [
                'type_of_nature'=>'required|in:Without Po Invoice',
                'generated_id'=>'required|exists:without_po_invoices,order_id',
