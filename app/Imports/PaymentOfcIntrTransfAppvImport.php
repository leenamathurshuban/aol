...
class PaymentOfcIntrTransfAppvImport implements ToModel, WithStartRow,WithHeadingRow,WithValidation,SkipsOnFailure
{
    ...
    */
    ...
    {
    	$data=InternalTransfer::where(['status'=>4,'order_id'=>$row['generated_id']])->first();
    	if ($data) {
    ...
    public function rules(): array
    {
        $valid='';
        return [
                'type_of_nature'=>'required|in:Internal Transfer',
                'generated_id'=>'required|exists:internal_transfers,order_id',
