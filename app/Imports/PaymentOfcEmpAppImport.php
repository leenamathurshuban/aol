...
class PaymentOfcEmpAppImport implements ToModel, WithStartRow,WithHeadingRow,WithValidation,SkipsOnFailure
{
    ...
    */
    ...
    {
    	$data=EmployeePay::where(['status'=>5,'order_id'=>$row['generated_id']])->first();
    	if ($data) {
    ...
    public function rules(): array
    {
        ...
        return [
                'type_of_nature'=>'required|in:Employee Pay',
                'generated_id'=>'required|exists:employee_pays,order_id',
